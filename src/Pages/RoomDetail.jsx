...
// // ── Booking URL helper ─────────────────────────────────────────────────────
// // Builds  /booking?room-type=XXXXXXX  when a room-type ID exists,
// // or falls back to the plain /booking page.
// const getBookingUrl = (roomType) =>
//   roomType ? `/booking?room-type=${roomType}` : '/booking'

// const getRoomBySlug = (slug) =>
//   roomsData.rooms.find((room) => room.slug === slug) || roomsData.rooms[0]
...
//                 </p>
//                 {/* ── Book Now CTA inside content panel ── */}
//                 <Link
//                   to={bookingUrl}
...
//                         style={{ backgroundImage: `url('${relatedRoom.images[0].url}')`, backgroundSize: 'cover', backgroundPosition: 'center', ...maskStyle }}
//                       />
//                       <div
...
//                         <p className="mt-1 text-sm text-white/70">{relatedRoom.price}</p>
//                         {/* ── Inline book link on related card ── */}
//                         <Link
//                           to={getBookingUrl(relatedRoom.bookingRoomType)}
...
//         `http://127.0.0.1:8000/api/ourrooms/${slug}`
//       );
...
//         description:
//           foundRoom.short_description || 'No description available.',

//         longDescription:
//           foundRoom.long_description || 'No details available.',

//         images:
//           foundRoom.images?.map(img => ({
//             url: img.image,
//             alt: foundRoom.name,
//           })) || [],

//         amenities: foundRoom.meta_data?.amenities || [],

//         tagline:
//           foundRoom.meta_data?.tagline || "Luxury Accommodation",
...
//                       <div
//                         className="absolute inset-0 w-full h-full transition duration-500 group-hover:scale-105"
//                         style={{ backgroundImage: `url('${relatedRoom.first_image || '/images/placeholder.jpg'}')`, backgroundSize: 'cover', backgroundPosition: 'center', ...maskStyle }}
//                       />
//                       <div
//                         className="absolute inset-0 w-full h-full pointer-events-none"
//                         style={{ backgroundColor: 'rgba(0,0,0,0.4)', ...maskStyle }}
